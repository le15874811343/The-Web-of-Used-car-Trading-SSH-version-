...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改车型</h2>
		<div class="manage">
			<form action="/S4SSHManager/Model_tjuptype.action" method="post" onsubmit="return chekSub()">
				<input type="hidden" name="op" value="tjuptype"/>
				<input type="hidden" name="tid" value="${upcartype.TId }"/>
				<input type="hidden" name="qtp" value="${upcartype.TClass }"/>
				<table class="form">
				<tr><td>车型名</td><td><input type="text" id="maxAge" name="maxAge" value="${upcartype.TName }" onblur="chek()"/><div id="chekAge" >${upbrand }</div></td></tr>
				<tr><td>热度</td><td colspan="4"><input type="text" id="count" name="count" value="${upcartype.TCount }" onblur="chekCount()" /><div id="d2" style="display: none;"></div></td><td></td></tr>
				<tr><td>车型Logo</td><td ><div align="center" style="height:200;border:5px solid red; " id="fa1"><img src="/S4SSHManager/${upcartype.TClass }"/></div><div style=" height:0px; overflow:hidden; position:absolute;" ><input type="file" id="filePath" name="filePath" onchange="fileupload('filePath','fa1','ttp')"/></div>
