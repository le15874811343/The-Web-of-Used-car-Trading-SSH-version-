...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li class="current" ><a href="/S4SSHManager/Manager_showalluser.action">用户</a></li>
...
<div id="main" class="wrap">
	...
	<div class="main">
		...
		<c:if test="${!empty info }">
                            ...
                            <tr align="center"><td colspan="2" >姓名：</td><td   >${info.UName }</td><td></td></tr>
                            <tr align="center"><td colspan="2">手机：</td><td>${info.UTel}</td><td></td></tr>
                            <tr align="center"><td colspan="2">QQ：</td><td><c:if test="${info.UQq!=0 }">${info.UQq}</c:if><c:if test="${info.UQq==0 }"></c:if></td><td></td></tr>
                            <tr align="center"><td colspan="2">Email：</td><td>${info.UEmail }</td><td></td></tr>
                            <tr  align="center"><td colspan="2">性别：</td><td colspan="5">${info.USex }</td></tr>
                                                        <tr  align="center"><td colspan="2" align="center">地址：</td><td colspan="5">${info.UAdr }</td></tr>
