...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改品牌</h2>
		<div class="manage">
			<form action="/S4SSHManager/Model_tjupbr.action" method="post" onsubmit="return chekSub()">
				<input type="hidden" name="op" value="tjupbr"/>
				<input type="hidden" name="bid" value="${brand.BId }"/>
				<input type="hidden" name="qtp" value="${brand.BImg }" />
				<table class="form">
				<tr><td>品牌名</td><td><input type="text" id="maxAge" name="maxAge"  value="${brand.BName }" onblur="chek()"/><div id="chekAge" >${upbrand }</div></td></tr>
				<tr><td>名称首字母</td><td><input type="text" id="zm" value="${brand.BSzm }" name="zm"  onblur="chekSzm()"/><div id="chekZm" style="display: none;"></div></td></tr>
				<tr><td>热度</td><td colspan="4"><input type="text" id="count" name="count" value="${brand.BCount }" onblur="chekCount()" /><div id="d2" style="display: none;"></div></td><td></td></tr>
				<tr><td>品牌Logo</td><td ><div align="center" style="height:200;border:5px solid red; " id="fa1"><img src="/S4SSHManager/${brand.BImg }"/></div><div style=" height:0px; overflow:hidden; position:absolute;" ><input type="file" id="filePath" name="filePath" onchange="fileupload('filePath','fa1','ttp')"/></div>
