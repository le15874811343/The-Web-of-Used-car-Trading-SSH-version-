...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>排放标准修改</h2>
		<div class="manage">
			<form action="/S4SSHManager/Model_tjemsi.action" method="post" onsubmit="return cheksub()">
				<input type="hidden" name="op" value="tjemsi"/>
				<input type="hidden" name="eid" value="${emsi.EId }"/>
				<table class="form">
				<tr><td>排放标准名称:</td><td><input type="text" id="name" value="${emsi.EName }" name="name" /><div id="dea" >${mea }</div></td></tr>
				<tr><td>热度</td><td colspan="4"><input type="text" id="count"  value="${emsi.ECount }" name="count" onblur="chekCount()" /><div id="d2" style="display: none;"></div></td><td></td></tr>
