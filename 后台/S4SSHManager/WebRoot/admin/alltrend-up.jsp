...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改动态</h2>
		<div class="manage">
			<form action="/S4SSHManager/Trends_tjuptrends.action" method="post" onsubmit="return cheksub('maxAge','chekAge','zm','chekZm')">
				...
				<tr><td>动态消息头图片</td><td ><div align="center" style="height:200;border:5px solid red; " id="fa1"><img src="/S4SSHManager/${utrends.trImg }" /></div><div style=" height:0px; overflow:hidden; position:absolute;" ><input type="file" id="filePath" name="filePath" onchange="fileupload('filePath','fa1','ttp')"/></div>
