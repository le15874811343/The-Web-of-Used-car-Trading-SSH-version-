    ...
    <div class="a-wb">
      <div class="wrap">
        ...
        <div class="a-div">
          ...
          <li class="clearfix"> 
              <a href="CarInfo_showDetails.action?cid=${trends.CId }&uid=${trends.UId}" target="_blank">
              <div class="img left dInline"> <img width="338" height="221" src="${ trends.CImg }"  /> </div>
              <div class="con right dInline">
                <div class="ne_tit clearfix">
                  <h2 class="left dInline"> ${trends.CBrand }${trends.CSeries }${trends.CReleaseyear }款 ${trends.CVolume }T ${trends.CGeartype } ${trends.CCode } ${trends.CModel } </h2>
                  <span class="right"> 点击量:${ trends.CCount }</span> </div>
                <p>${ trends.CCzzx }</p>
