...
<html>
  <head>
    ...
    <title>${_trends.trTitle}-亿金新闻-郑州高品质二手车专家_河南亿金名车广场</title>
...
<c:if test="${!empty userinfo }"> <a id="MemberMenuChange" href="MemberCenter_showmenber.action" target="_self">会员中心</a></c:if>
    ...
    ${userinfo.UName } 
      ...
      </a>|<a  href="UserInfo_zhuXiao.action?op=zhuxiao&url=execute"  id="b-regist">注销</a>|&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/tel.png"/>			
      </c:if>
      </span>
		</div>
	</div>
...
<div id="about">
	...
	<a href="CarInfo.action">亿金名车广场</a>><a href="Trends_showNewsList.action">亿金动态</a>><a >${_trends.trTitle }</a>	</div>
	...
	<div class="wAbout">
		<div class="a-wa">
          ...
          <li class="on"><a href="Trends_showNewsList.action" >亿金动态</a></li>
			...
			<div class="wrap">
				...
				<div class="a-div" style="padding-bottom:30px">
					<div class="news_detail">
						<h2>${_trends.trTitle}</h2>
						<div align="center">${_trends.trDate }</div>
						<div class="news_p">
							...
							<a href="Trends_showNewsList.action" class="backList">返回列表</a>
						</div>
					</div>
				</div>
			</div>
