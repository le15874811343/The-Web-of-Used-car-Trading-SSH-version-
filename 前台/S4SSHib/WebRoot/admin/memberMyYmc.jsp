        ...
        <div class="mr-detail">
          <div class="mr-tab clearfix"> <a  href="MemberCenter_showmenberYbcar.action" >我购买的车</a> 
            ...
            <a href="MemberCenter_showmenberJyz.action">被订购的车</a>
              <a class="on" href="MemberCenter_showmenberymw.action">出售成功的车</a>
          </div>
          ...
          <div class="me-dl" >
            ...
            <div class="me-dl"  style="display:block;">
							...
							</p><div class="price clearfix" style="margin:5px 0;"><div class="left dInline pNum">	<font>一口价</font><br/><span class="num nBlue">${szCar.value.CPrice}</span><font> 万元</font>			 </div>			<span class="num1 left" style="height:43px;padding-top:10px;"><em></em><br/>						</span>		</div>		<div class="cs_bt clearfix">			</div>	</div></li></ul><div class="hPages">    </div>
							</c:forEach>
							</c:if>
								</div>
