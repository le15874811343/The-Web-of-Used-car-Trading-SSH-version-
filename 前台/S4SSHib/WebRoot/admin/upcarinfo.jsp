		...
		<div class="top">
			<div class="wrap clearfix">
				...
				<div class="nav left dInline" id="headerMenu">
					<a href="CarInfo.action">首页</a> <a href="about.jsp">关于亿金</a>
					<a href="CarInfo_showList.action">我要买车</a> <a class="on"
						href="MemberCenter_needmaiche.action">我要卖车</a> <a
						href="CarInfo_showsrdz.action">私人定制</a>
					<!--<a href="shfw.html">售后服务</a>-->
					<c:if test="${!empty userinfo }">
						<a id="MemberMenuChange" href="MemberCenter_showmenber.action"
							target="_self">会员中心</a>
					</c:if>
					<c:if test="${empty userinfo }">
				...
				<span class="right" id="rightMenuHtml"> <c:if
						...
						<a href="MemberCenter_showmenber.action">
							${userinfo.UName } </a>|<a
							href="UserInfo_zhuXiao.action?url=execute">注销</a>|&nbsp;&nbsp;&nbsp;&nbsp;<img
							src="images/tel.png" />
					</c:if> </span>
			</div>
		</div>
...
#jShow {
	...
	<div id="about">
		<div class="mTags wrap">
			<a href="#">亿金名车广场</a>><a href="#">我要卖车</a>><a href="#"><c:if
			...
			<div class="buyDetail">
				...
				<div class="b-cont">
					<div id="cBox1" class="c_box">
						<h2>${car.CBrand}${car.CSeries }${car.CType }</h2>
						<div class="ca-dl">
											...
											<td><div align="center"
												...
												<div
													...
													<input type="file" id="file" name="file"
														onchange="fileupload('file','fa1','ttp')" />
						...
						<form name="upform" action="MemberCenter_uptj.action" method="post"
							...
							<input
								type="hidden" name="brad" value="${car.CBrand }"> <input
								type="hidden" name="cx" value="${car.CSeries }"> <input
								type="hidden" name="cxi" value="${car.CType}"> <input
								type="hidden" name="ttp" value="${car.CImg }"> <input type="hidden"
									...
									<table>
										<tr>
											...
											<td><input placeholder="*必选" class="for_datetime cPut"
												...
												name="stime" value="${car.CLicencetime }"
												onblur="chekspz()" />
											...
											<td><input type="text" placeholder="*必填(如领先型,时尚型等)"
												value="${car.CModel }" id="carxh" name="carxh"
										...
										<tr>
											...
											<td><input type="text" placeholder="*必填(小型,大型,房车等)"
												value="${car.CType }" id="cartype" name="cartype"
											...
											<td><input type="text" placeholder="*必填(限正整数或一位小数)"
												value="${car.CVolume }" id="dis" name="dis"
											...
											<td><input type="text" placeholder="*必填(如730li等)"
												value="${car.CCode }" id="carbh" name="carbh"
										...
										<table>
											<tr>
												...
												<td><input type="text" placeholder="*必填(国三,国四,国五等)"
													value="${car.CEmissionstandard }" id="stan" name="stan"
												...
												<td><input type="text" id="travel" name="travel"
													placeholder="*必填(限8以下正整数或一位小数)" value="${car.CDistance }"
											...
											<table>
												<tr>
													...
													<td><input type="text" placeholder="*必选"
														value="${car.CReleaseyear }" class="form_datetime cPut"
										...
										<table>
											<tr>
												<td colspan="8"><textarea id="txta" name="txta"
														style="width:1050px">${car.CCzzx }</textarea>
												</td>
											</tr>
