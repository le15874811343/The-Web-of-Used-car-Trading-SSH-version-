...
<html>
  <head>
    ...
    <title>${_trends.CBt}-亿金新闻-郑州高品质二手车专家_河南亿金名车广场</title>
...
<div id="about">
	<div class="mTags wrap">
		<a href="CarInfo.action">亿金名车广场</a>><a href="Trends_showCom.action">客户留言</a>><a >${_trends.CBt }</a>
	</div>
			...
			<div class="wrap">
				...
				<div class="a-div" style="padding-bottom:30px">
					<div class="news_detail">
						<h2>${_trends.CBt}</h2>
						<div align="center">${_trends.CDate}</div>
						<div class="news_p">
							...
							<a href="Trends_showCom.action" class="backList">返回列表</a>
						</div>
					</div>
				</div>
			</div>
