...
function sendRequest(sel){
  ...
  if(sel.value!="选择品牌"){
  var url = "Model_execute.action?brand="+brand+"&nocahe="+new Date().getTime()+"";
  CreateXMLHttp();
  if(xmlhttp){
...
alert("留言失败")}
  ...
  <div class="top">
    <div class="wrap clearfix"> <a href="#" class="logo left"><img src="images/logo.png"/></a>
      ...
      <a class="on" href="CarInfo_showList.action">我要买车</a>
    ...
    ${userinfo.UName } 
      ...
      <tr><td>            
        <input type="hidden" name="tname"  value="${tname}">
             ...
             <input type="hidden" name="url" value="showList">
      </td></tr>
      </table>
      </form>
      </c:if>
        ...
        <div class="cs-tit">
          <div class="clearfix">
            <div class="ctLeft left dInline">
              ...
              <div class="cs_sub"> 排序： <a class="cs-a1" href="CarInfo_showList.action?tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age}&emsi=${emsi}">默认<img src="images/down.gif"/></a> <a href="CarInfo_showList.action?tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=CCount">点击量<img src="images/down.gif"/></a> <a href="CarInfo_showList.action?tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=CSccount">收藏量<img src="images/down.gif"/></a> <a href="CarInfo_showList.action?tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=CPrice">价格<img src="images/up.gif"/></a> <a href="CarInfo_showList.action?tname=${tname}&bname=${bname }&cser=${cser}&price=${price }&distance=${distance}&age=${age }&emsi=${emsi}&order=CDistance">里程<img src="images/up.gif"/></a> </div>
            </div>
